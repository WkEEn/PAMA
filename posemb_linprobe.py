...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = models_posemb.__dict__[args.model](num_kernel=args.max_kernel_num, img_size=args.max_size, patch_size=1,
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    return '{:.3f}'.format(losses.avg), '{:.3f}'.format(losses.avg), '{:.3f}'.format(top1.avg), '{:.3f}'.format(top2.avg), '{:.3f}'.format(micro_auc), '{:.3f}'.format(macro_auc), '{:.3f}'.format(weighted_auc)
