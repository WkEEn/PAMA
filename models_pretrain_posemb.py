...
class PamaViT(nn.Module):
    ...
    def __init__(self, num_kernel=64, in_chans=256,
    ...
    def forward(self, imgs, wsi_rd, wsi_polar, token_mask, kernel_mask, device, mask_ratio=0.75):
        ...
        pred = self.forward_decoder(latent, ids_restore,wsi_rd, wsi_polar, token_mask, kernel_mask, kernel_tokens, device)  # [N, L, p*p*3]
